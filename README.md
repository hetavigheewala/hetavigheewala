...
- AI Automation for startup productivity
- Enhancing personal portfolio projects
...
|-----------------|--------------|
| Frontend        | React, Next.js, Tailwind CSS, TypeScript, HTML |
| Backend         | Node.js, Python (AI/ML), C++, Notion.js |
...
## 🚀 Featured Projects
Here are a few projects that showcase my ability to handle complex architectures, AI workflows, and full-stack integration:
